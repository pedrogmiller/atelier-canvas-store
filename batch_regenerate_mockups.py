...
def batch_update_all_mockups():
    ...
    print(f"Compositing art on REAL photography room backgrounds for {len(products)} collections...")
    ...
    for idx, p in enumerate(products, 1):
        ...
        print(f"  [{idx:02d}/{len(products)}] Real photography mockups generated: {title[:40]}...")

    print("\nAll collections successfully upgraded with REAL photography rooms!")
